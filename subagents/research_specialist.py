"""
Research Specialist Subagent — LLM-driven market research.
...
Return only synthesized insights — never raw search dumps.
"""
...
def delegate_to_researcher(task: str) -> str:
    ...
    for msg in reversed(result["messages"]):
        if hasattr(msg, "content") and isinstance(msg.content, str) and msg.content.strip():
            return msg.content
    return "Research complete — no summary produced."
